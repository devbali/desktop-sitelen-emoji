...
## MacOS
- Download the <a href="https://raw.githubusercontent.com/devbali/desktop-sitelen-emoji/master/macossitelenemoji.inputplugin" download>macossitelenemoji.inputplugin</a> file from this repository
...
- Download the <a href="https://raw.githubusercontent.com/devbali/desktop-sitelen-emoji/master/linuxibus.txt" download>linuxibus.txt</a> file and run command `sudo ibus-table-createdb -n /usr/share/ibus-table/tables/sitelenemoji.db -s linuxibus.txt` from the same directory
